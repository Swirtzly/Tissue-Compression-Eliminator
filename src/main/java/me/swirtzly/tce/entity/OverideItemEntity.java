 ...
 * on 15/01/2020 @ 20:20
 */
public class OverideItemEntity extends Entity {

    private static final DataParameter<ItemStack> ITEM = EntityDataManager.createKey(OverideItemEntity.class, DataSerializers.ITEMSTACK);
    private static final DataParameter<Float> HEIGHT = EntityDataManager.createKey(OverideItemEntity.class, DataSerializers.FLOAT);
    private static final DataParameter<Float> WIDTH = EntityDataManager.createKey(OverideItemEntity.class, DataSerializers.FLOAT);
    private double motionX, motionY, motionZ;

    public OverideItemEntity(World worldIn, double x, double y, double z, ItemStack stack) {
        this(worldIn);
    ...
    public OverideItemEntity(World worldIn, double x, double y, double z, ItemStack stack, float height, float width) {
        this(worldIn);
    ...
    public OverideItemEntity(EntityType type, World world) {
        this(world);
    }

    public OverideItemEntity(World worldIn) {
        super(RegHandler.EntityEntries.ITEM_OVERRIDE_ENTITY_TYPE, worldIn);
        this.setEntitySize(getWidth(), getHeight());
        this.setItem(new ItemStack(RegHandler.Items.TCE));
    }
    ...
    public interface IEntityOverride {
        ...
        void update(OverideItemEntity itemOverride);
